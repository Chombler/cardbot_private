...
from tables import card, cardclass, cardset, cardtoclass, cardtodeck, cardtotrait, cardtotribe, cardtype, card_constructor, cost_type, deck, hero, rarity, nickname, supertohero, trait, tribe
